...
<div class="row">
    ...
    while ($row = $query->fetch_assoc()) {
        ...
        ?>
    <div class="item_generos col-sm-6 col-md-3 col-lg-2" id="item-<?= $row[$idname] ?>" onclick="conenct_post_arr('collection', 'set_serie',['serie', <?= $row[$idname] ?>]);"> 
